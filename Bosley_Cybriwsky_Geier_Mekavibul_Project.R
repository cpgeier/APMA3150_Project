...
abline(mean(properties_2m$taxvaluedollarcnt,na.rm=TRUE),sd(properties_2m$taxvaluedollarcnt,na.rm=TRUE),col='red')

# Testing whether or not the bedroom count of the house is correlated with the tax valuation of the house 
t.test(properties_2m$taxvaluedollarcnt[properties_2m$bedroomcnt==1],properties_2m$taxvaluedollarcnt[properties_2m$bedroomcnt==2])
t.test(properties_2m$taxvaluedollarcnt[properties_2m$bedroomcnt==1],properties_2m$taxvaluedollarcnt[properties_2m$bedroomcnt==3])
t.test(properties_2m$taxvaluedollarcnt[properties_2m$bedroomcnt==2],properties_2m$taxvaluedollarcnt[properties_2m$bedroomcnt==3])
# p-value < 2.2e-16
# Highly significant, p value < 0.05. The mean house valuation is different for 2 and 3 bedroom houses

t.test(properties_2m$taxvaluedollarcnt[properties_2m$bedroomcnt==6],properties_2m$taxvaluedollarcnt[properties_2m$bedroomcnt==8])
# p-value = 0.1498
